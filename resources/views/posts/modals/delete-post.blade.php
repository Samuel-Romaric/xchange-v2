<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalDeletePost"
    @delete-post.window="openModalDeletePost($event.detail.url, $event.detail.title)" x-cloak>

    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalDeletePost" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalDeletePost" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalDeletePost" @keydown.escape="closeModalDeletePost"
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg leading-6 font-medium text-gray-700">Supprimer la publication</h3>
                        </div>

                        <div class="mt-5">
                            <form action="" method="POST" class="w-full" id="deletePostForm">
                                @csrf
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" @click.prevent="deletePost" id="deletePostAction"
                ...
                <button type="button" @click.prevent="closeModalDeletePost"
