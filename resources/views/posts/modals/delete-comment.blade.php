<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalDeleteComment"
    @delete-comment.window="openModalDeleteComment($event.detail.url, $event.detail.commentContent)" x-cloak>

    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalDeleteComment" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalDeleteComment" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalDeleteComment" @keydown.escape="closeModalDeleteComment"
            ...
            <div class="bg-white px-3 py-3">
                <div class="sm:flex sm:items-start">
                    <div
                        ...
                        <span class="h-8 w-8 text-red-700 text-4xl text-center">
                            <x-heroicon-o-trash class="h-7 w-7" />
                        </span>
                    </div>
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg leading-6 font-medium text-gray-700">Supprimer mon commentaire</h3>
                        </div>

                        <div class="mt-5">
                            <form action="" method="POST" class="w-full" id="deleteCommentForm">
                                @csrf
                                <div class="flex items-start rounded-md space-x-2 text-gray-500">
                                    <p>
                                        Voulez-vous vraiment supprimer ce commentaire : <b class="iName"></b> ?
                                    </p>
                                </div>
                            </form>
                        </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" @click.prevent="deleteComment" id="deleteCommentAction"
                ...
                <button type="button" @click.prevent="closeModalDeleteComment"
